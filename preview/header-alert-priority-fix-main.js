(function(){
  ...
  frame.addEventListener('load',function(){
    ...
    if(!w||!d||d.__upperHeaderAlertPriorityFixMain)return;
    d.__upperHeaderAlertPriorityFixMain=true;

    const style=d.createElement('style');
    style.id='upperHeaderAlertPriorityFixStylesMain';
    style.textContent=`
      @keyframes ur-main-header-alert-5{
      ...
      .app-header.ur-turn-alert-5{
        ...
        animation:ur-main-header-alert-5 .85s ease-in-out infinite!important;
      }
