(function(){
  ...
  frame.addEventListener('load',function(){
    ...
    const TRACK_ALIASES={
      pannoniaring:['pannoniaring','pannonia'],
      slovakia:['slovakiaring','slovakia'],
      'brünn':['brünn','brunn','brno','masaryk'],
      most:['most'],
      grobnik:['grobnik','rijeka']
    };

    function selectedTrackKey(){
      const el=d.getElementById('trackSelect');
    ...
    function todayInside(range){
      ...
      return n>=range.start.getTime()&&n<=range.end.getTime();
    }
    ...
    function ensureStyles(){
      ...
      s.textContent=`
        ...
        .stardesign-live-title{font-weight:900;color:#ffd400}
        .stardesign-live-status{color:#aaa;margin-top:4px;line-height:1.4}
        ...
        .stardesign-live-btn:disabled{opacity:.5;cursor:default}
        .stardesign-live-link{display:block;margin-top:7px;color:#ddd;text-decoration:underline;font-size:.7rem}
      `;
    ...
    function ensureBox(){
      ...
      const old=d.getElementById('stardesignAutoSchedule');
      if(old)old.remove();
      let box=d.getElementById('stardesignLiveSchedule');
      if(box)return box;
      box=d.createElement('div');
      box.id='stardesignLiveSchedule';
      box.className='stardesign-live-box';
